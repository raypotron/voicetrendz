  ...
  return (
    <>
      ...
      >
        ...
        {/* Search Overlay */}
        {isSearchOpen && (
          <div className={`absolute top-16 left-0 w-full ${isDarkMode ? 'bg-gradient-to-r from-[#060A1A] via-[#0A102A] to-[#050515]' : 'bg-white'} border-b border-gray-200 dark:border-gray-800 shadow-lg animate-in slide-in-from-top-2 duration-200`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
              <form onSubmit={handleSearch} className="relative">
                <input
                  ...
                  autoFocus
                  className={`w-full pl-12 pr-12 py-3 rounded-xl ${isDarkMode ? 'bg-gradient-to-r from-[#060A1A] via-[#0A102A] to-[#050515]' : 'bg-white'} border-none focus:ring-2 focus:ring-purple-500 transition-all`}
                />
