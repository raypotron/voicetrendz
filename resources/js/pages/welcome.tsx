                        ...
                        <div className="absolute inset-0 flex items-end bg-gradient-to-t from-black/80 to-transparent">
                          <div className="w-full p-4">
                            <div className="flex items-center gap-3 text-sm text-white">
                              <span>👁 45K</span>
                              <span>⏱ {dayjs(story.created_at).fromNow()}</span>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div className="space-y-6">
            ...
            <div className={`${cardBg} rounded-xl p-6 shadow-lg`}>
              <h3 className="mb-4 flex items-center gap-2 text-xl font-bold">
                <TrendingUp className="h-5 w-5 text-purple-600" /> Trending Topics
              </h3>
            ...
            <div className={`${cardBg} rounded-xl p-6 shadow-lg`}>
              <h3 className="mb-4 flex items-center gap-2 text-xl font-bold">
                <Music className="h-5 w-5 text-purple-600" /> Song Lyrics
              </h3>
              {songLyrics.length > 0 ? (
                <div className="space-y-2">
                  {songLyrics.map((lyric) => (
                    <Link key={lyric.id} href={route('lyrics.show', lyric.slug)}>
                      <div
                        className={`rounded-lg p-3 ${
                          isDarkMode
                            ? 'bg-gray-700 hover:bg-gray-600'
